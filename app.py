...
app = Flask(__name__, template_folder="templates", static_folder="static")
app.secret_key = os.getenv("FLASK_SECRET_KEY", "bae89494e226be61f439aa0f8a1b4e085313b32e5e2faba851ea2a17fa6d749e")
...
N8N_WEBHOOK_URL = os.getenv("N8N_WEBHOOK_URL", "https://anaronn8n.duckdns.org/webhook/chat-alcaldia")
REQUEST_TIMEOUT = 180
